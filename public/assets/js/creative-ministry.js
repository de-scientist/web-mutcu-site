document.addEventListener("DOMContentLoaded", function () {
  try {
    ...
    if (typeof bootstrap !== "undefined") {
      // Initialize modals
      const joinMinistryModal = new bootstrap.Modal(
        document.getElementById("joinMinistryModal"),
      );
      ...
      if (joinForm) {
        joinForm.addEventListener("submit", function (e) {
          ...
          if (this.checkValidity()) {
            ...
            console.log(
              "Form submitted successfully. Simulating server response.",
            );
      ...
      console.warn(
        "Bootstrap library not loaded. Modals and form validation may not function.",
      );
    }
  } catch (error) {
