document.addEventListener("DOMContentLoaded", () => {
  ...
  document
    .querySelectorAll('a.nav-link[href^="#"], .btn[href^="#"]')
    .forEach((anchor) => {
  ...
  const musicMinistryJoinForm = document.getElementById(
  ...
  if (musicMinistryJoinForm) {
    musicMinistryJoinForm.addEventListener("submit", function (event) {
      ...
      document
        .getElementById("modalConfirmationMessage")
        .classList.remove("d-none"); // Show confirmation
    ...
    joinMinistryModal.addEventListener("hidden.bs.modal", function () {
      ...
      document
        .getElementById("modalConfirmationMessage")
        .classList.add("d-none"); // Hide confirmation
    });
  }
});
