// src/pages/committees/BibleStudyCommittee.tsx
import React from "react";
import { Link } from "react-router-dom";

const BibleStudyCommittee: React.FC = () => {
  return (
    <>
      {/* Hero */}
      <section
            ...
            <div className="col-lg-10">
              <ul className="list-unstyled roles-list">
                <li data-aos="fade-up" data-aos-delay="100">
                  ...
                  facilitating regular small group Bible studies for members.
                </li>
                <li data-aos="fade-up" data-aos-delay="200">
                  <i className="fas fa-check-circle me-3"></i> Conducting
                  nurturing classes specifically designed for new believers to
                  establish their faith.
                </li>
                <li data-aos="fade-up" data-aos-delay="300">
                  <i className="fas fa-check-circle me-3"></i> Coordinating the
                  Bible Exposition Self-Training Program (BEST-P) for in-depth
                  biblical understanding.
                </li>
                <li data-aos="fade-up" data-aos-delay="400">
                  <i className="fas fa-check-circle me-3"></i> Developing and
                  providing resources for personal and group discipleship.
                </li>
                <li data-aos="fade-up" data-aos-delay="500">
                  <i className="fas fa-check-circle me-3"></i> Encouraging
                  practical application of biblical teachings in members&apos;
...
export default BibleStudyCommittee;
